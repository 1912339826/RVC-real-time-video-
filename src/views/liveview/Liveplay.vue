...
export default {
  ...
  methods: {
    ...
    PlayVideo(token, streamprofile, label, name) {
      ...
      if (this.$store.state.clusterliveviewrtc == "RTC" || H5siOS() === true) {
        console.log(this.$store.state.clusterliveviewrtc);
    ...
    PtzActionwiperon(event) {
      console.log("雨刷开");
      this.PtzAction("wiperon", "27", "1", "");
    },
    PtzActionwiperoff(event) {
      console.log("雨刷关");
      this.PtzAction("wiperoff", "28", "1", "");
    },
    PtzActionlighton(event) {
      console.log("灯光开");
      this.PtzAction("lighton", "27", "2", "");
    },
    PtzActionlightoff(event) {
      console.log("灯光关");
      this.PtzAction("lightoff", "28", "2", "");
    },
    PtzActionfocusing(event) {
      ...
      this.PtzAction("focusin", "25", "2", this.focusing);
    },
    PtzActionfocusings(event) {
      ...
      this.PtzAction("focusout", "26", "2", this.focusing);
    },
    PtzActionaperture(event) {
      ...
      this.PtzAction("irisin", "21", "2", this.aperture);
    },
    PtzActionaperturej(event) {
      ...
      this.PtzAction("irisout", "22", "2", this.aperture);
    },
    ...
    PtzActionZoomIn(event) {
      ...
      this.PtzAction("zoomin", "23", "2", this.Zoom);
    },
    PtzActionZoomOut(event) {
      ...
      this.PtzAction("zoomout", "24", "2", this.Zoom);
    },
    ...
    PtzActionStop(event) {
      ...
      this.PtzAction("stop",'1','','');
    },

    PtzAction(action, controlCode, controlPara1, controlPara2) {
      let token = document
        .getElementsByClassName("h5videoh")[0]
        .getElementsByTagName("video")[0]
        .getAttribute("data-token");
      let cameraCode = document
        .getElementsByClassName("h5videoh")[0]
        .getElementsByTagName("video")[0]
      ...
      // console.log(action,'11111111111111111111111111111111111111',this.videoid)
                  if (this.h5handler == undefined)
                  {
                      return;
                  }
      ...
      var ptzcmd =
        ...
        controlPara2;
      var url =
        this.$store.state.IPPORT + "/camera/camera/ptzControl?" + ptzcmd;
