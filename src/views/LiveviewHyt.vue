      ...
      <div class="header">
        ...
        <section class="header_right">
          <div class="liveview_group blocks">
            <el-button
              type="button"
              class="iconfont icon-tubiao_huaban11"
              data-row="1|1"
              @click="changePanel($event)"
            ></el-button>
            <el-button
              type="button"
              class="iconfont icon-tubiao_huaban1fuben1"
              data-row="1|3"
              @click="changePanel($event)"
            ></el-button>
            <el-button
              type="button"
              class="iconfont icon-tubiao_huaban1fuben21"
              data-row="2|2"
              @click="changePanel($event)"
            ></el-button>
            ...
            <el-button
              type="button"
              class="iconfont icon-tubiao_huaban1fuben31"
              data-row="1|6"
              @click="changePanel($event)"
            ></el-button>
            <el-button
              type="button"
              class="iconfont icon-tubiao_huaban1fuben41"
              data-row="1|7"
              @click="changePanel($event)"
            ></el-button>
            ...
            <el-button
              type="button"
              class="iconfont icon-tubiao_huaban1fuben51"
              data-row="3|3"
              @click="changePanel($event)"
            ></el-button>
            ...
            <el-button
              type="button"
              class="iconfont icon-tubiao_huaban1fuben61"
              data-row="1|13"
              @click="changePanel($event)"
            ></el-button>
            ...
            <el-button
              type="button"
              class="iconfont icon-tubiao_huaban1fuben71"
              data-row="4|4"
              @click="changePanel($event)"
            ></el-button>
            <el-button
              type="button"
              class="iconfont icon-tubiao_huaban1fuben8"
              data-row="5|5"
              @click="changePanel($event)"
            ></el-button>
            <el-button type="button" @click="panelFullScreen($event)">
              <div class="panelFullScreen">全屏</div>
            </el-button>
        ...
        <div class="con_left">
          <section class="JTKZ">
            ...
            <div class="section_con">
              <div class="top">
                <div class="left">
                  <div class="iconfont_son">
                    <span class="iconfont icon-jian"></span><span>变倍</span
                    ><span class="iconfont icon-jia"></span>
                  </div>
                  <div class="iconfont_son">
                    <span class="iconfont icon-jian"></span><span>焦距</span
                    ><span class="iconfont icon-jia"></span>
                  </div>
                  <div class="iconfont_son">
                    <span class="iconfont icon-jian"></span><span>光圈</span
                    ><span class="iconfont icon-jia"></span>
                  </div>
                </div>
                ...
                <span slot-scope="{ data }" style="width: 100%">
                  ...
                  >
                    ...
                    >
                      ...
                      ></span>
                      <span
                        :class="data.iconclass1"
                        style="padding-left: 4px"
                        >{{ data.label }}</span
                      >
                    </span>
                    <span :class="data.iconclass2" class="black" style="">{{
                      $t("message.live.Videorecording")
                    }}</span>
                  </div>
                </span>
              </el-tree>
    ...
    async viewClick(data) {
      ...
      for (var i = 0; i < data.src.length; i++) {
        ...
        if (data.src[i].strStream == "main") {
          label =
            data.src[i].strName + "--" + this.$t("message.live.mainstream");
        } else if (data.src[i].strStream == "sub") {
          label =
            data.src[i].strName + "--" + this.$t("message.live.substream");
        }
        console.log(label);
        var vdata = {
    ...
    .header {
      ...
      .header_left {
        ...
        .search {
          ...
          .el-button--primary {
            background-color: rgba(50, 122, 182, 1);
    ...
    .con {
      ...
      .con_left {
        ...
        .JKSH {
          ...
          .el-tree {
            background: rgba(129, 211, 248, 0.0901961) !important;
          }
        }
      }
